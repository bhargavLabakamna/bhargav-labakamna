                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-messages">
                        ...
                        <li>
                            <a href="#">
                                <div>
                                    <strong><span class=" label label-info">Bhargav Patel</span></strong>
                                    <span class="pull-right text-muted">
                                        <em>Yesterday</em>
                                    </span>
                                </div>
                        ...
                        <li>
                            <a href="#">
                                <div>
                                    <strong><span class=" label label-success">Bhargav Patel</span></strong>
                                    <span class="pull-right text-muted">
                                        <em>Yesterday</em>
                                    </span>
                                </div>
        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <div class="sidebar-collapse">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <!-- </li> -->
                     <!-- <li>
                        <a href="timeline"><i class="fa fa-flask fa-fw"></i>Timeline</a>
                    </li> -->
                    <li>
                        <a href="contact_list"><i class="fa fa-comments-o fa-fw"></i>Contacts</a>
                    </li>
                    <li>
                        <a href="banner_list"><i class="fa fa-table fa-fw"></i>Banners</a>
                    </li>
                    <li>
