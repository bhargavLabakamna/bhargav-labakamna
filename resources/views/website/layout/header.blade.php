...
<head>
	...
	<!-- favicon -->
	<link rel="shortcut icon" type="image/png" href="{{url('website/assets/img/favicon.png')}}">
	<!-- google font -->
	...
	<!-- owl carousel -->
	<link rel="stylesheet" href="{{url('website/assets/css/owl.carousel.css')}}">
	<!-- magnific popup -->
					...
					<div class="main-menu-wrap">
						...
						<nav class="main-menu">
							<ul>
								...
								<li><a id="login_model_open">Login</a></li>
								<li>
